...
public class MazeRunner {
    ...
    private static String movementKeys = "WASDwasd";
    ...
    public static void main(String[] args) {
        ...
        if (movementKeys.contains(nextMove)) {
            userMover(nextMove);
        } else {
            System.out.println("Please use 'W' 'A' 'S' 'D' to move");
    ...
    public static void intro() {
        ...
        System.out.println("Hello, and welcome to the Maze.\n" +
                "The \"x\" represents your location.\n" +
                "Good luck making your way through the Maze!");
        myMap.printMap();
    }

    public static String userMover(String nextMove) {

        String canIMove = "You shall not pass";

        if (nextMove.equalsIgnoreCase("w")) {

            if(myMap.canIMoveUp())
            {
                canIMove =  "Player can move";
            }
        } else if (nextMove.equalsIgnoreCase("a")) {
    ...
    /**
     * This is the MazeRunner.Maze class. It has all of the methods and information needed
     ...
     * move through a wall or a pit MazeRunner.Maze throws an exception and terminates the program.
    ...
    public static class Maze {
        ...
        /**
         * Instantiate a new MazeRunner.Maze object.
         */
        public Maze() {
            row = 1;
            col = 0;
